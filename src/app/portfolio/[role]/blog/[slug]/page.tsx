...
export default async function RoleBlogPostPage({ params }: Props) {
      ...
      <article className="prose prose-invert prose-lg max-w-none">
        ...
        <div
          className="blog-content text-foreground/80 leading-relaxed space-y-6 
            ...
            [&>a]:text-secondary [&>a]:underline [&>a]:hover:text-secondary/80 mt-8"
        >
          <ReactMarkdown
