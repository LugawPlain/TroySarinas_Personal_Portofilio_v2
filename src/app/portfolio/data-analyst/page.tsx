...
import BubbleChartSection from "@/components/BubbleChartSection";
...
export default async function DataAnalystPortfolio() {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-blue-500/30">
      <main className="space-y-0 pb-20">
        ...
        {/* 2. Bubble Chart - Project Universe */}
        <TrackedSection id="bubble_chart_view">
          <BubbleChartSection />
        </TrackedSection>

        {/* 3. Projects - Data stories */}
        <TrackedSection id="projects_view">
          <Projects initialProjects={projects} />
        </TrackedSection>

        {/* 3. Experience - Impact metrics */}
        <TrackedSection id="experience_view">
          <Experience initialExperience={experience} />
        </TrackedSection>

        {/* 4. Technologies - Pipeline diagram */}
        <TrackedSection id="skills_view">
          <Technologies initialTech={tech} />
        </TrackedSection>

        {/* 5. Certifications - Data credentials */}
