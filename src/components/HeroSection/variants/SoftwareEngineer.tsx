      ...
      >
        ...
        <div className="flex flex-col justify-center px-4 sm:px-8 pt-24 pb-12 sm:py-16 xl:px-20 xl:py-20 w-full xl:w-[55%] xl:max-w-[55%] z-10">
          ...
          {config.showSocialLinks && (
            <SocialLinks className="" size={28} links={socialLinks} />
          )}
        ...
        <div className="flex flex-col justify-center px-4 sm:px-8 py-6 sm:py-8 xl:px-12 xl:py-20 w-full xl:w-[45%] xl:max-w-[45%] gap-4 sm:gap-6">
          ...
          <div className="flex flex-col sm:flex-row w-full relative gap-4 xl:gap-8">
            ...
            <div className="flex-1 min-w-0 backdrop-blur-[20%]  bg-linear-to-br from-[rgba(102,126,234,0.15)] to-[rgba(118,75,162,0.1)] hover:from-[rgba(102,126,234,0.10)] hover:to-[rgba(118,75,162,0.1)] hover:shadow-[rgba(118,75,162,0.8)] transition-all duration-150 shadow-2xl shadow-[rgba(118,75,162,0.4)] border-[rgba(102,126,234,0.3)] border-2 rounded-3xl flex flex-col px-4 py-4 gap-2 overflow-hidden">
              <div className="flex flex-row gap-4">
