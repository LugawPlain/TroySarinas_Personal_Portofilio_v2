...
const GTMHeader = () => {
  ...
  const navLinks = [
    ...
    { name: "Tech Stack", href: "#technologies", id: "technologies" },
  ];
        ...
        <div className="flex items-center gap-6">
            ...
            <ul className="flex gap-1 text-base items-center">
              ...
              <li className="ml-2">
                <Button
                  ...
                  className="text-sm font-semibold px-6 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white tracking-tight shadow-lg shadow-emerald-500/20 rounded-full transition-all hover:shadow-xl hover:shadow-emerald-500/30 hover:-translate-y-0.5"
                >
          ...
          <div className="relative">
            <button
              ...
              aria-label="Settings"
            >
              <Settings className="text-gray-500 hover:text-emerald-600 transition-colors" size={22} />
            </button>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between py-3 px-2 hover:bg-gray-50 rounded-lg transition-colors">
                        ...
                        <button
                          ...
                          className={`relative cursor-pointer inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                            isCursorEffectEnabled ? "bg-emerald-600" : "bg-gray-200"
                          }`}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform shadow-sm ${
                ...
                <ul className="flex flex-col gap-1">
                  ...
                  <li className="mt-2 pt-2 border-t border-gray-100">
                    <Button
                      ...
                      className="w-full text-sm font-semibold py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white tracking-tight shadow-lg rounded-xl"
                    >
                      <MessageCircle className="w-4 h-4 mr-2" />
                      Let's Talk Strategy
                    </Button>
