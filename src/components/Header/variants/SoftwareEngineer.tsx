        ...
        <div className="mx-4 sm:mx-6 lg:mx-8 mt-4">
          ...
          >
            ...
            >
              ...
              >
                <Terminal className="w-4 h-4 sm:w-5 sm:h-5 text-secondary/80" />
              </div>
              <div className="hidden sm:flex flex-col">
                <span className="font-spacemono text-sm font-bold text-secondary tracking-tight leading-none">
                  Troy Sarinas
                </span>
                <span className="font-spacemono text-[10px] text-stone-500 tracking-wider uppercase">
                  Software Engineer
                </span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Button
                ...
                className="hidden sm:flex rounded-full font-spacemono text-sm font-semibold 
                  px-5 py-2.5 bg-secondary hover:bg-secondary/90 text-secondary-foreground 
              ...
              <>
                <motion.div
                  ...
                  className="absolute right-6 sm:right-10 top-full mt-2 w-64 
                    backdrop-blur-[20px] bg-white/80 border border-[rgba(102,126,234,0.2)] 
                    rounded-2xl shadow-xl shadow-[rgba(102,126,234,0.1)] overflow-hidden z-50"
                >
                  <div className="p-4 space-y-3">
                    ...
                    <div className="flex items-center justify-between py-2">
                      <div className="flex items-center gap-2.5">
                        {isDarkMode ? (
                          <Moon className="w-4 h-4 text-secondary/70" />
                        ) : (
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-300 ${
                          isDarkMode ? "bg-secondary" : "bg-stone-200"
                        }`}
                      >
                        <span
              ...
              >
                ...
                <div className="px-6 py-4 border-b border-[rgba(102,126,234,0.1)]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="font-spacemono text-sm font-bold text-secondary block">
                        Troy Sarinas
                      </span>
                      <span className="font-spacemono text-[10px] text-stone-500 tracking-wider uppercase">
                        Software Engineer
                          ...
                          >
                            ...
                            {active && (
                              <motion.div
                                ...
                                className="ml-auto w-1.5 h-1.5 rounded-full bg-secondary/60"
                              />
                            )}
                          </a>
                        </li>
                ...
                {/* Mobile CTA */}
                <div className="p-4 border-t border-[rgba(102,126,234,0.1)]">
                  <Button
                    onClick={() => {
                    ...
                    className="w-full rounded-full font-spacemono text-sm font-semibold 
                      py-3 bg-secondary hover:bg-secondary/90 text-secondary-foreground 
